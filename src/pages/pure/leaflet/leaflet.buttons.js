...
L.Control.Buttons = L.Control.extend({
  ...
  _addGroup: function () {
    var group = L.DomUtil.create(
      "div",
      "leaflet-control-buttons-group leaflet-bar leaflet-control",
      this._container
    );
    return group;
  },
  ...
  _addButton: function (btn, g) {
    ...
    var tootltip = L.DomUtil.create(
      "span",
      "leaflet-control-buttons-tooltip",
      button
    );
      ...
      this._onClick.call(
        {
          prop: btn,
          element: button,
          defaultClass: button.childNodes[0].classList.value,
        },
        {}
      );
    }
